...
?>
        ...
        <head>
            ...
            <link rel="stylesheet" href="/public/assets/client/css/vendor.css">
            <link rel="stylesheet" type="text/css" href="/public/assets/client/style.css">
                    ...
                    <div class="container-lg">
                        <div class="row justify-content-evenly">
                            ...
                            <div class="col d-none d-md-block">
                                <p class="text-center text-black m-0"><strong>Ưu đãi đặc biệt</strong>: Miễn phí vận chuyển cho tất cả các đơn hàng trên 500.000VND
                                </p>
                            </div>
                            <div class="col">
                ...
                <nav id="header-nav" class="navbar navbar-expand-lg">
                    <div class="container-lg">
                        <a class="navbar-brand" href="/">
                            <img src="/public/assets/client/images/Shoes store.png" class="logo" alt="logo" style="width: 100px; height:min-content;">
                        </a>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar">
                            <div class="offcanvas-header px-4 pb-0">
                                <a class="navbar-brand ps-3" href="index.html">
                                    <img src="/public/assets/client/images/main-logo.png" class="logo" alt="logo">
                                </a>
                                ...
                                <ul id="navbar" class="navbar-nav fw-bold justify-content-end align-items-center flex-grow-1">
                                    <!-- <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu fw-bold">
                                            <li>
                                                <a href="index.html" class="dropdown-item">Trang chủ V1</a>
                                            </li>
                                            <li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link me-5" href="/products">Sản phẩm</a>
                                    </li>
                                    <!-- <li class="nav-item">
                                    ...
                                    <!-- <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu fw-bold">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="index.html">Sản phẩm đơn</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="index.html">Bài đăng đơn</a>
                                            </li>
                                            <li>
